...
export const mainListItems = (
  <div>
    ...
    <ListItem button>
      ...
      <ListItemText primary="My Receipts" />
    </ListItem>
  </div>
);
...
export function Dashboard( {setAuth} ) {
  ...
  useEffect(() => {
      getname();
      Get_Employee();//eslint-disable-next-line
  },[]);
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
            {/* view profile */}
            <h2 style={{textAlign : 'center'}}>Welcome Employee {Mydata.user_name}</h2>
            <Profile Mydata={Mydata}/>
            {/* <FileUpload /> */}
            <div className='container mt-5'><FileUpload Mydata={Mydata}/></div>
            <div className='container mt-5'><DisplayReceipts /></div>
        </Container>
      </main>
    </div>
  );
